...
public class DrinkAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            holder.iPriceTextView = (TextView)convertView.findViewById(R.id.iPriceTextView);
        ...
        holder.iPriceTextView.setText(String.valueOf(drink.getIPrice()));
//        holder.imageView.setImageResource(drink.imageId);
//        Picasso.with(inflater.getContext()).load(drink.getImage().getUrl()).into(holder.imageView);//load位置，需網路
        drink.getImage().getFileInBackground(new GetFileCallback() {//可以用local的檔
            @Override
